...
export let HSSideNav = /*#__PURE__*/function () {
    ...
    _createClass(HSSideNav, [{
        ...
        value: function init() {
            ...
            $("body").off("click",".js-navbar-vertical-aside-toggle-invoker").on('click', '.js-navbar-vertical-aside-toggle-invoker', function (e) {
                // Toggle aside menu
