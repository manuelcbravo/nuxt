...
* Copyright 2021 Htmlstream
*/,
HSCore.components.HSValidation={_baseConfig:{errorElement:"div",errorClass:"invalid-feedback",rules:{},onkeyup:function(e){$(e).valid()},errorPlacement:function(){},highlight:function(){},unhighlight:function(){}},pageCollection:$(),init:function(e,i){if(this.collection=e&&$(e).length?$(e):$(),$(e).length)return this.config=i&&$.isPlainObject(i)?$.extend({},this._baseConfig,i):this._baseConfig,this.config.itemSelector=e,this.initValidation(),this.pageCollection},initValidation:function(){var e=this,i=e.config,t=e.pageCollection;this.collection.each(function(n,s){var a=$(s);a.hasClass("js-step-form")?$.validator.setDefaults({ignore:":hidden:not(.active select)"}):$.validator.setDefaults({ignore:":hidden:not(select)"}),a.validate({errorElement:i.errorElement,errorClass:i.errorClass,rules:i.rules,onkeyup:i.onkeyup,errorPlacement:!0==isEmpty(i.errorPlacement)?e.errorPlacement:i.errorPlacement,highlight:!0==isEmpty(i.highlight)?e.highlight:i.highlight,unhighlight:!0==isEmpty(i.unhighlight)?e.unHighlight:i.unhighlight}),$("select").change(function(){$(this).valid()}),t=t.add(a)})},errorPlacement:function(e,i){var t=$(i).data("error-msg-classes");e.addClass(t),e.appendTo(i.parents(".js-form-message"))},highlight:function(e){var i=$(e),t=i.data("error-class"),n=i.data("success-class");i.parents(".js-form-message").removeClass(n).addClass(t)},unHighlight:function(e){var i=$(e),t=i.data("error-class"),n=i.data("success-class");i.parents(".js-form-message").removeClass(t).addClass(n)}}
